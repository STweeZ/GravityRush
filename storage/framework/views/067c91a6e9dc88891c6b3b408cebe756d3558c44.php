<?php $__env->startSection('content'); ?>
    <div id="container_form">
        <div id="content_form">
            <form method="POST" action="<?php echo e(route('register')); ?>" id="form_login">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" placeholder="NOM">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\STweeZ\Desktop\Projet - Laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>